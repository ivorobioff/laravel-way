...
use Restate\QA\Support\Filters\CompositeFilter;
...
use RealEstate\Core\Appraisal\Enums\Request as AppraiserRequest;
...
$includes = [
	...
	'loanType', 'approachesToBeIncluded',
			...
			'emails' => function(Runtime $runtime){
				...
				return  [
					'body' => [
						[
							'from' => [
								'no-reply@realestate.com' => 'The RealEstate Team'
							],
							'to' => [
