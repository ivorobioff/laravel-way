...
use RealEstate\Console\Support\DoctrineKernel as Doctrine;
...
use RealEstate\DAL\Support\ConnectionFactory;
...
use RealEstate\DAL\Location\Fixtures\States;
...
class ProjectResetCommand extends Command
{
    ...
    public function fire(Doctrine $doctrine, Application $application, EntityManagerInterface $entityManager)
    {
        ...
        $class = 'RealEstate\Seeding\\' . ucfirst(camel_case($application->environment())) . 'Seeder';
