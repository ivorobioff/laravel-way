...
use RealEstate\DAL\Support\Metadata\CompositeDriver;
use RealEstate\DAL\Support\Metadata\PackageDriver;
...
use RealEstate\DAL\Support\Metadata\SimpleDriver;
...
class DoctrineServiceProvider extends ServiceProvider
{
    ...
    private function registerTypes(Connection $connection, array $packages, array $extra = [])
    {
        foreach ($packages as $package) {
            ...
            $typeNamespace = 'RealEstate\DAL\\' . $package . '\Types';
